    ...
    <div className='mt-12 w-11/12 mx-auto'>
      ...
      <div className='md:px-10 flex flex-wrap gap-6 justify-between items-center'>
        {features.map(({ title, des, img }) => (
          <div
            key={img}
            className='lg:w-[296px] w-full h-[281px] border border-[#ffffff]/5 bg-[#ffffff]/[2%] hover:bg-[#ffffff]/[4%] rounded-[18px] p-[1.875rem] pl-[1.75rem] transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,230,143,0.1)]'
          >
